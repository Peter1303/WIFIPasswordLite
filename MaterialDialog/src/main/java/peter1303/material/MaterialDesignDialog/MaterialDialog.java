...
public class MaterialDialog
{
	...
	public MaterialDialog setDialogBGColorResource(int color){
		dialogBG=color;
		return this;
	}
    ...
    private class Builder {
        ...
        private Builder() {
			...
			if(dialogBG!=0){
				mPositiveButton.setTextColor(dialogBG);
				mNegativeButton.setTextColor(dialogBG);
				mNeutralButton.setTextColor(dialogBG);
			}
